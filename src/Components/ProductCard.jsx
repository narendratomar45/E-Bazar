...
const ProductCard = ({ item, index }) => {
  ...
  return (
    <div
      key={index}
      className="w-[300px] max-sm:w-[400px]  bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition-all duration-300 border-2 border-indigo-600 transform  "
    >
